          ...
          <form class="form-save" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" value="{{ $data->mb_kode }}" readonly="" class="form-control" name="kode"
                    readonly="">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="kategori" class="form-control">
                    ...
                    <option value="{{ $kategori->mk_id }}" @if ($kategori->mk_id == $data->mb_kategori)
                      selected=""
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="penerbit" class="form-control">
                    ...
                    <option value="{{ $penerbit->mpn_id }}" @if ($penerbit->mpn_id == $data->mb_penerbit)
                      selected=""
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="pengarang" class="form-control">
                    ...
                    <option value="{{ $pengarang->mpg_id }}" @if ($pengarang->mpg_id == $data->mb_pengarang)
                      selected=""
                      @endif
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Desc</label>
                  <textarea class="form-control" name="desc" rows="5">{{ $data->mb_desc }}</textarea>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <table class="table  table-bordered table-stripped">
              ...
              <tbody class="drop">
                ...
                <tr class="remove_exist_{{ $index }}">
                  <th>
                    <input type="number" class=" form-control" @if($element->mbdt_status == 'TERPINJAM')
                    style="pointer-events: none"
                    readonly="" @endif value="{{ $element->mbdt_isbn }}" name="isbn[]">
                  </th>
                  <th>
                    <select name="kode_rak_dt[]" class="form-control" @if($element->mbdt_status == 'TERPINJAM')
                      readonly="" @endif>
                      @foreach ($rak_bukus as $rak_buku )
                      <option value="{{ $rak_buku->mrbd_kode }}" @if ($rak_buku->mrbd_kode ==
                        $element->mbdt_rak_buku_dt)
                        selected=""
                        @endif
                  ...
                  <th>
                    <select name="status[]" class="form-control" @if($element->mbdt_status == 'TERPINJAM')
                  ...
                  <th>
                    <select name="kondisi[]" class="form-control" @if($element->mbdt_status == 'TERPINJAM')
                      style="pointer-events: none" readonly="" @endif>
                  ...
                  <th>
                    ...
                    <button type="button" class="btn btn-sm btn-danger" onclick="remove_tr_exist('{{ $index }}')">
                      <i class="fas fa-trash btn-block"></i> Hapus
                    </button>
                    @else
