        ...
        <div class="card-body" style="display: block;">
          <form class="form-save">
            <div class="form-group">
              <label>Kode</label>
              <input type="text" class="form-control" name="kode" value="{{ $data->mf_kode }}"  readonly="">
              <input type="hidden" class="form-control" name="id" value="{{ $data->mf_id }}">
            </div>
            <div class="form-group">
              <label>Nama</label>
              <input type="text" class="form-control" name="name" value="{{ $data->mf_name }}">
            </div>
        </div>
        <!-- /.card-body -->
      ...
      success:function(data){
        if (data.status == 'sukses') {
          Swal.fire({
            ...
            location.href = '{{ route('fakultas_index') }}';
             })
        }
      }
    });
