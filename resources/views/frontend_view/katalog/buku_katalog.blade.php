		...
		<div class="row">
			<div class="col-xl-3 col-sm-6">
				<div class="similar-song">
					...
					<div class="single_player">
						<div class="jp-jplayer jplayer" data-ancestor=".jp_container_8" data-url="music-files/3.mp3">
						</div>
			...
			<div class="col-xl-3 col-sm-6">
				<div class="similar-song">
					...
					<p>A book of Azriel in <b>Category</b></p>
					<div class="single_player">
						<div class="jp-jplayer jplayer" data-ancestor=".jp_container_9" data-url="music-files/4.mp3">
						</div>
			...
			<div class="col-xl-3 col-sm-6">
				<div class="similar-song">
					...
					<p>A book of Azriel in <b>Category</b></p>
					<div class="single_player">
						<div class="jp-jplayer jplayer" data-ancestor=".jp_container_10" data-url="music-files/5.mp3">
						</div>
			...
			<div class="col-xl-3 col-sm-6">
				<div class="similar-song">
					...
					<p>A book of Azriel in <b>Category</b></p>
					<div class="single_player">
						<div class="jp-jplayer jplayer" data-ancestor=".jp_container_11" data-url="music-files/7.mp3">
						</div>
